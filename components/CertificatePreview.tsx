          ...
          >
            <div className="relative w-full max-w-[440px] bg-white rounded-sm shadow-[0_40px_80px_rgba(0,0,0,0.6)] p-1 overflow-hidden border-[8px] md:border-[12px] border-[#1e293b]">
              ...
              <div className="w-full h-full bg-white border-2 md:border-4 border-[#e2e8f0] p-6 md:p-10 flex flex-col items-center text-center relative">
                ...
                {/* Certificate Header */}
                {/* Certificate Header - Height Fixed Logic */}
                <div className="flex flex-col items-center mb-2 md:mb-4"> {/* Margin kam kiya height bachane ke liye */}
                  <div className="relative mb-2">
                    {/* Subtle Glow behind logo - doesn't take extra space */}
                  ...
                  <h4 className="text-[#1e293b] font-black text-sm md:text-base tracking-tighter leading-none">
                    VIPASIKA <span className="text-blue-600">🦬</span>
                  </h4>
                  <p className="text-[5px] md:text-[6px] font-bold uppercase tracking-[0.3em] text-gray-400">
